...
//    public ArrayList<Matiere>findNiveau(@Param("niveau")String niveau);
	...
	@Query("select m.nom from Matiere m where m.classe like(:nom) ")
	public ArrayList<String> loadMatiereByClasse(@Param("nom")String nom);
	
	@Query("select m from Matiere m where m.classe like(:nom) ")
	public ArrayList<Matiere> loadMatiereByClasseObject(@Param("nom")String nom);
